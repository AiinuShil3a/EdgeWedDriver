...
class AllWebDriver {
	...
	void test() throws Exception {
		...
		if(browser.equalsIgnoreCase("Edge")) {
			...
			System.setProperty("webdriver.gecko.driver", "D:\\YEAR 2 TERM 2\\T.Naruphon\\Driver\\FirefoxDriver\\geckodriver.exe");
			driver = new FirefoxDriver();
		
		}
		else if(browser.equalsIgnoreCase("Google")) {
			
			System.setProperty("webdriver.chrome.driver", "D:\\YEAR 2 TERM 2\\T.Naruphon\\Driver\\ChromeDriver\\chromedriver.exe");
